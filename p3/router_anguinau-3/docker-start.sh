...
LOOPBACK_IP=1.1.1.3 # Adresse IP de l'interface loopback.

VXLAN_NAME=vxlan10 # Nom de l'interface VXLAN.
VXLAN_ID=10 # Identifiant du VXLAN (VNI).

VTEP_IF=eth1 # Interface réseau qui envoie/reçoit les paquets VXLAN (VTEP).
VTEP_IP=10.1.1.6/30 # Adresse IP de l'interface VTEP.
...
OSPF_NET=10.1.1.4/30 # Réseau du lien OSPF vers le RR.
